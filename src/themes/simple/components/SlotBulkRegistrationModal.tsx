...
import { SimpleSpreadsheetGrid } from './SpreadsheetGrid';
...
interface SlotBulkRegistrationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
}

export function SlotBulkRegistrationModal({ isOpen, onClose, onSuccess }: SlotBulkRegistrationModalProps) {
